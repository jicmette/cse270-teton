...
class TestSmokeTest():
  ...
  def test_joinPage(self):
    ...
    assert len(elements) > 0
    self.driver.find_element(By.NAME, "fname").send_keys("Israel")
    elements = self.driver.find_elements(By.NAME, "lname")
    assert len(elements) > 0
    self.driver.find_element(By.NAME, "lname").send_keys("Carmona")
    elements = self.driver.find_elements(By.NAME, "bizname")
    assert len(elements) > 0
    self.driver.find_element(By.NAME, "bizname").send_keys("Nexbitek")
  ...
  def test_adminPage(self):
    ...
    assert len(elements) > 0
    self.driver.find_element(By.ID, "password").send_keys("hola1")
